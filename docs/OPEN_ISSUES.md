...
| 🟡 Medium | Confirm AT&T fiber plan speed — drives Firewalla model selection | Eero Pro 7 Max has a 10GbE WAN port. Firewalla Gold SE WAN is only 2.5GbE — it will cap throughput at ~2.3Gbps. If AT&T plan is multi-gig (2Gbps+), consider Firewalla Gold Plus (2.5GbE, ~$600) or Gold Pro (10GbE, ~$900) instead. See NETWORK_PLAN.md §4 Procurement. | [docs/NETWORK_PLAN.md](NETWORK_PLAN.md) §4 | Jeremy | Before ordering Firewalla |
